"""
Healthcare & Insurance Defense Matrix: Medical Coding Inflation & CPT Upcoding Detection Matrix
Domain Key: medical_upcoding
"""
...
def get_medical_upcoding_rules() -> List[Rule]:
    """Returns full calibrated rules for Medical Coding Inflation & CPT Upcoding Detection Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_001",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #01",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_002",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #02",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_003",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #03",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_004",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #04",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_005",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #05",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_006",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #06",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_007",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #07",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_008",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #08",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_009",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #09",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_010",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #10",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_011",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #11",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_012",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #12",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_013",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #13",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_014",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #14",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_015",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #15",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_016",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #16",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_017",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #17",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_018",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #18",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_019",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #19",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_020",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #20",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_021",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #21",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_022",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #22",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_023",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #23",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_024",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #24",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_MEDICAL_UPCODING_025",
            name="Medical Coding Inflation & CPT Upcoding Detection Matrix - Rule #25",
            description="Healthcare and insurance anomaly evaluation for medical_upcoding at tier 25.",
            priority=55,
            conditions=[
