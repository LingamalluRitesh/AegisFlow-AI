"""
Healthcare & Insurance Defense Matrix: Property Casualty Arson & Inflated Inventory Loss Defense
Domain Key: property_casualty_arson
"""
...
def get_property_casualty_arson_rules() -> List[Rule]:
    """Returns full calibrated rules for Property Casualty Arson & Inflated Inventory Loss Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_001",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #01",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_002",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #02",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_003",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #03",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_004",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #04",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_005",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #05",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_006",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #06",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_007",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #07",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_008",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #08",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_009",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #09",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_010",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #10",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_011",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #11",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_012",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #12",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_013",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #13",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_014",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #14",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_015",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #15",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_016",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #16",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_017",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #17",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_018",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #18",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_019",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #19",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_020",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #20",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_021",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #21",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_022",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #22",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_023",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #23",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_024",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #24",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_PROPERTY_CASUALTY_ARSON_025",
            name="Property Casualty Arson & Inflated Inventory Loss Defense - Rule #25",
            description="Healthcare and insurance anomaly evaluation for property_casualty_arson at tier 25.",
            priority=55,
            conditions=[
