"""
Healthcare & Insurance Defense Matrix: Unbundled Diagnostic Panel & Excessive Laboratory Claims
Domain Key: unbundled_laboratory_tests
"""
...
def get_unbundled_laboratory_tests_rules() -> List[Rule]:
    """Returns full calibrated rules for Unbundled Diagnostic Panel & Excessive Laboratory Claims."""
    rules = []
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_001",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #01",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_002",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #02",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_003",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #03",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_004",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #04",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_005",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #05",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_006",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #06",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_007",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #07",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_008",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #08",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_009",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #09",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_010",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #10",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_011",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #11",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_012",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #12",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_013",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #13",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_014",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #14",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_015",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #15",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_016",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #16",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_017",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #17",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_018",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #18",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_019",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #19",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_020",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #20",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_021",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #21",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_022",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #22",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_023",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #23",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_024",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #24",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_UNBUNDLED_LABORATORY_TESTS_025",
            name="Unbundled Diagnostic Panel & Excessive Laboratory Claims - Rule #25",
            description="Healthcare and insurance anomaly evaluation for unbundled_laboratory_tests at tier 25.",
            priority=55,
            conditions=[
