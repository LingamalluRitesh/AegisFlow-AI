"""
Healthcare & Insurance Defense Matrix: Telehealth High-Frequency Rapid Consultation Matrix
Domain Key: telehealth_overutilization
"""
...
def get_telehealth_overutilization_rules() -> List[Rule]:
    """Returns full calibrated rules for Telehealth High-Frequency Rapid Consultation Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_001",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #01",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_002",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #02",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_003",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #03",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_004",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #04",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_005",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #05",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_006",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #06",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_007",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #07",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_008",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #08",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_009",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #09",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_010",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #10",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_011",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #11",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_012",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #12",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_013",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #13",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_014",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #14",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_015",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #15",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_016",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #16",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_017",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #17",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_018",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #18",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_019",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #19",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_020",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #20",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_021",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #21",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_022",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #22",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_023",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #23",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_024",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #24",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="HLTH_TELEHEALTH_OVERUTILIZATION_025",
            name="Telehealth High-Frequency Rapid Consultation Matrix - Rule #25",
            description="Healthcare and insurance anomaly evaluation for telehealth_overutilization at tier 25.",
            priority=55,
            conditions=[
