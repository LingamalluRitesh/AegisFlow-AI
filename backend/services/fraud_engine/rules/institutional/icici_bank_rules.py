"""
Institutional Defense Matrix: ICICI India iMobile & Pockets Wallet Risk Matrix
Institution Identifier: icici_bank
"""
...
def get_icici_bank_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for ICICI India iMobile & Pockets Wallet Risk Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_001",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_002",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_003",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_004",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_005",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_006",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_007",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_008",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_009",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_010",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_011",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_012",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_013",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_014",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_015",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_016",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_017",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_018",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_019",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_ICICI_BANK_020",
            name="ICICI India iMobile & Pockets Wallet Risk Matrix - Rule Variant #20",
