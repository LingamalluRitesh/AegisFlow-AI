"""
Institutional Defense Matrix: RBC Interac e-Transfer & Wire Interception Defense
Institution Identifier: royal_bank_canada
"""
...
def get_royal_bank_canada_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for RBC Interac e-Transfer & Wire Interception Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_001",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_002",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_003",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_004",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_005",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_006",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_007",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_008",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_009",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_010",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_011",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_012",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_013",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_014",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_015",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_016",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_017",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_018",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_019",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_ROYAL_BANK_CANADA_020",
            name="RBC Interac e-Transfer & Wire Interception Defense - Rule Variant #20",
