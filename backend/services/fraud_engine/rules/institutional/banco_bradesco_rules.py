"""
Institutional Defense Matrix: Bradesco Latin America Card-Not-Present Defense
Institution Identifier: banco_bradesco
"""
...
def get_banco_bradesco_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for Bradesco Latin America Card-Not-Present Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_001",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_002",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_003",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_004",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_005",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_006",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_007",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_008",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_009",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_010",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_011",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_012",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_013",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_014",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_015",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_016",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_017",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_018",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_019",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_BANCO_BRADESCO_020",
            name="Bradesco Latin America Card-Not-Present Defense - Rule Variant #20",
