"""
Institutional Defense Matrix: DBS Singapore Fast & Secure Instant Payment Rules
Institution Identifier: dbs_bank
"""
...
def get_dbs_bank_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for DBS Singapore Fast & Secure Instant Payment Rules."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_001",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_002",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_003",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_004",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_005",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_006",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_007",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_008",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_009",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_010",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_011",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_012",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_013",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_014",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_015",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_016",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_017",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_018",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_019",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_DBS_BANK_020",
            name="DBS Singapore Fast & Secure Instant Payment Rules - Rule Variant #20",
