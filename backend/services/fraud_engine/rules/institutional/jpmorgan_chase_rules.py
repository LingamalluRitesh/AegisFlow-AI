"""
Institutional Defense Matrix: JPMorgan Chase Enterprise Defense Matrix
Institution Identifier: jpmorgan_chase
"""
...
def get_jpmorgan_chase_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for JPMorgan Chase Enterprise Defense Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_001",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_002",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_003",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_004",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_005",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_006",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_007",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_008",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_009",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_010",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_011",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_012",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_013",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_014",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_015",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_016",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_017",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_018",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_019",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_JPMORGAN_CHASE_020",
            name="JPMorgan Chase Enterprise Defense Matrix - Rule Variant #20",
