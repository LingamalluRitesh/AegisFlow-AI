"""
Institutional Defense Matrix: Westpac Institutional Risk & Fraud Detection Matrix
Institution Identifier: westpac_group
"""
...
def get_westpac_group_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for Westpac Institutional Risk & Fraud Detection Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_001",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_002",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_003",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_004",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_005",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_006",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_007",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_008",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_009",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_010",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_011",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_012",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_013",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_014",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_015",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_016",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_017",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_018",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_019",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_WESTPAC_GROUP_020",
            name="Westpac Institutional Risk & Fraud Detection Matrix - Rule Variant #20",
