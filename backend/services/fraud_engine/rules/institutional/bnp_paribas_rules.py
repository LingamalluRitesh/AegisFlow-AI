"""
Institutional Defense Matrix: BNP Paribas SEPA Corporate Wire & Remittance Defense
Institution Identifier: bnp_paribas
"""
...
def get_bnp_paribas_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for BNP Paribas SEPA Corporate Wire & Remittance Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_001",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_002",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_003",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_004",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_005",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_006",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_007",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_008",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_009",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_010",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_011",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_012",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_013",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_014",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_015",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_016",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_017",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_018",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_019",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_BNP_PARIBAS_020",
            name="BNP Paribas SEPA Corporate Wire & Remittance Defense - Rule Variant #20",
