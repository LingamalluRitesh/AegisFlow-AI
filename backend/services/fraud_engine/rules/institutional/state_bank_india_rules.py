"""
Institutional Defense Matrix: SBI India High-Volume UPI & IMPS Transaction Defense
Institution Identifier: state_bank_india
"""
...
def get_state_bank_india_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for SBI India High-Volume UPI & IMPS Transaction Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_001",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_002",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_003",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_004",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_005",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_006",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_007",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_008",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_009",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_010",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_011",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_012",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_013",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_014",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_015",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_016",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_017",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_018",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_019",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_STATE_BANK_INDIA_020",
            name="SBI India High-Volume UPI & IMPS Transaction Defense - Rule Variant #20",
