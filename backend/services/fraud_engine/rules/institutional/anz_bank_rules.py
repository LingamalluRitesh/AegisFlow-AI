"""
Institutional Defense Matrix: ANZ Australia & New Zealand PayID Anomaly Rules
Institution Identifier: anz_bank
"""
...
def get_anz_bank_rules() -> List[Rule]:
    """Returns compliance rule definitions calibrated for ANZ Australia & New Zealand PayID Anomaly Rules."""
    rules = []
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_001",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #01",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_002",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #02",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_003",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #03",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_004",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #04",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_005",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #05",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_006",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #06",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_007",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #07",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_008",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #08",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_009",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #09",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_010",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #10",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_011",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #11",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_012",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #12",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_013",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #13",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_014",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #14",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_015",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #15",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_016",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #16",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_017",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #17",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_018",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #18",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_019",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #19",
    ...
    rules.append(
        Rule(
            rule_id="INST_ANZ_BANK_020",
            name="ANZ Australia & New Zealand PayID Anomaly Rules - Rule Variant #20",
