"""
Telecom & IoT Defense Matrix: Synthetic Subscriber Identity & Handset Subsidy Fraud
Domain Key: subscriber_churn_fraud
"""
...
def get_subscriber_churn_fraud_rules() -> List[Rule]:
    """Returns full calibrated rules for Synthetic Subscriber Identity & Handset Subsidy Fraud."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_001",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_002",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_003",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_004",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_005",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_006",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_007",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_008",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_009",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_010",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_011",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_012",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_013",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_014",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_015",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_016",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_017",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_018",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_019",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_020",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_021",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_022",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_023",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_024",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SUBSCRIBER_CHURN_FRAUD_025",
            name="Synthetic Subscriber Identity & Handset Subsidy Fraud - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for subscriber_churn_fraud at tier 25.",
            priority=55,
            conditions=[
