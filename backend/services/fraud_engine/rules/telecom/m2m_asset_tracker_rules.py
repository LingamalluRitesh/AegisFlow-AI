"""
Telecom & IoT Defense Matrix: M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense
Domain Key: m2m_asset_tracker
"""
...
def get_m2m_asset_tracker_rules() -> List[Rule]:
    """Returns full calibrated rules for M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_001",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_002",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_003",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_004",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_005",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_006",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_007",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_008",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_009",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_010",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_011",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_012",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_013",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_014",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_015",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_016",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_017",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_018",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_019",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_020",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_021",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_022",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_023",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_024",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_M2M_ASSET_TRACKER_025",
            name="M2M Asset Tracker Jamming & Geo-Fence Spoofing Defense - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for m2m_asset_tracker at tier 25.",
            priority=55,
            conditions=[
