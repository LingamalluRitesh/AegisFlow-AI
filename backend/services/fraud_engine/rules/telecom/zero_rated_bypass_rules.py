"""
Telecom & IoT Defense Matrix: Zero-Rated Data Tunneling & VPN Data Bypass Matrix
Domain Key: zero_rated_bypass
"""
...
def get_zero_rated_bypass_rules() -> List[Rule]:
    """Returns full calibrated rules for Zero-Rated Data Tunneling & VPN Data Bypass Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_001",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_002",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_003",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_004",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_005",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_006",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_007",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_008",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_009",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_010",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_011",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_012",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_013",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_014",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_015",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_016",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_017",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_018",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_019",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_020",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_021",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_022",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_023",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_024",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_ZERO_RATED_BYPASS_025",
            name="Zero-Rated Data Tunneling & VPN Data Bypass Matrix - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for zero_rated_bypass at tier 25.",
            priority=55,
            conditions=[
