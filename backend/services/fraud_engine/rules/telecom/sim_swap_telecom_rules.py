"""
Telecom & IoT Defense Matrix: Carrier SIM Swap & IMSI Detach Anomaly Matrix
Domain Key: sim_swap_telecom
"""
...
def get_sim_swap_telecom_rules() -> List[Rule]:
    """Returns full calibrated rules for Carrier SIM Swap & IMSI Detach Anomaly Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_001",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_002",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_003",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_004",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_005",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_006",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_007",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_008",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_009",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_010",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_011",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_012",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_013",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_014",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_015",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_016",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_017",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_018",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_019",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_020",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_021",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_022",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_023",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_024",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SIM_SWAP_TELECOM_025",
            name="Carrier SIM Swap & IMSI Detach Anomaly Matrix - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for sim_swap_telecom at tier 25.",
            priority=55,
            conditions=[
