"""
Telecom & IoT Defense Matrix: Direct Carrier Billing (DCB) Silent Subscription Defense
Domain Key: carrier_billing_direct
"""
...
def get_carrier_billing_direct_rules() -> List[Rule]:
    """Returns full calibrated rules for Direct Carrier Billing (DCB) Silent Subscription Defense."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_001",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_002",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_003",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_004",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_005",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_006",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_007",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_008",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_009",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_010",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_011",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_012",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_013",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_014",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_015",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_016",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_017",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_018",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_019",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_020",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_021",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_022",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_023",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_024",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_CARRIER_BILLING_DIRECT_025",
            name="Direct Carrier Billing (DCB) Silent Subscription Defense - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for carrier_billing_direct at tier 25.",
            priority=55,
            conditions=[
