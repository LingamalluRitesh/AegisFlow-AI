"""
Telecom & IoT Defense Matrix: SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix
Domain Key: smishing_gateway
"""
...
def get_smishing_gateway_rules() -> List[Rule]:
    """Returns full calibrated rules for SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix."""
    rules = []
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_001",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #01",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 1.",
            priority=7,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_002",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #02",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 2.",
            priority=9,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_003",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #03",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 3.",
            priority=11,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_004",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #04",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 4.",
            priority=13,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_005",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #05",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 5.",
            priority=15,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_006",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #06",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 6.",
            priority=17,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_007",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #07",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 7.",
            priority=19,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_008",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #08",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 8.",
            priority=21,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_009",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #09",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 9.",
            priority=23,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_010",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #10",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 10.",
            priority=25,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_011",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #11",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 11.",
            priority=27,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_012",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #12",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 12.",
            priority=29,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_013",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #13",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 13.",
            priority=31,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_014",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #14",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 14.",
            priority=33,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_015",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #15",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 15.",
            priority=35,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_016",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #16",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 16.",
            priority=37,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_017",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #17",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 17.",
            priority=39,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_018",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #18",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 18.",
            priority=41,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_019",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #19",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 19.",
            priority=43,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_020",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #20",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 20.",
            priority=45,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_021",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #21",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 21.",
            priority=47,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_022",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #22",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 22.",
            priority=49,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_023",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #23",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 23.",
            priority=51,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_024",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #24",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 24.",
            priority=53,
            conditions=[
    ...
    rules.append(
        Rule(
            rule_id="TEL_SMISHING_GATEWAY_025",
            name="SMS Gateway Smishing & Bulk Aggregator Spoofing Matrix - Rule #25",
            description="Telecom risk and IoT telemetry anomaly check for smishing_gateway at tier 25.",
            priority=55,
            conditions=[
