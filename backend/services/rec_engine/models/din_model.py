"""
PulseRec Neural Architecture: DeepInterestNetwork
Deep Interest Network (DIN) with local activation unit modeling dynamic user attention
"""
...
logger = get_logger("rec.neural.din_model")

class DeepInterestNetworkConfig(BaseModel):
...
class DeepInterestNetwork:
    ...
    def __init__(self, config: Optional[DeepInterestNetworkConfig] = None):
        self.config = config or DeepInterestNetworkConfig()
