"""
PulseRec Neural Architecture: CrossStitchMultiTaskNet
Cross-Stitch Network learning optimal linear combinations of shared multi-task representations
"""
...
logger = get_logger("rec.neural.cross_stitch")

class CrossStitchMultiTaskNetConfig(BaseModel):
...
class CrossStitchMultiTaskNet:
    """Cross-Stitch Network learning optimal linear combinations of shared multi-task representations"""

    def __init__(self, config: Optional[CrossStitchMultiTaskNetConfig] = None):
        self.config = config or CrossStitchMultiTaskNetConfig()
