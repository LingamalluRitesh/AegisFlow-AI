"""
PulseRec Neural Architecture: NeuralFactorizationMachineV2
Neural Factorization Machine coupling second-order feature interactions with deep neural layers
"""
...
logger = get_logger("rec.neural.nfm_v2")

class NeuralFactorizationMachineV2Config(BaseModel):
...
class NeuralFactorizationMachineV2:
    """Neural Factorization Machine coupling second-order feature interactions with deep neural layers"""

    def __init__(self, config: Optional[NeuralFactorizationMachineV2Config] = None):
        self.config = config or NeuralFactorizationMachineV2Config()
