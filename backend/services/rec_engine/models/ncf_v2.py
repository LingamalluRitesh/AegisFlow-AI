"""
PulseRec Neural Architecture: NeuralCollaborativeFilteringV2
Neural Collaborative Filtering fusing generalized matrix factorization with non-linear multi-layer perceptrons
"""
...
logger = get_logger("rec.neural.ncf_v2")

class NeuralCollaborativeFilteringV2Config(BaseModel):
...
class NeuralCollaborativeFilteringV2:
    ...
    def __init__(self, config: Optional[NeuralCollaborativeFilteringV2Config] = None):
        self.config = config or NeuralCollaborativeFilteringV2Config()
