"""
PulseRec Neural Architecture: VariationalAutoencoderRec
Variational Autoencoder (Mult-VAE) utilizing multinomial likelihood for collaborative ranking
"""
...
logger = get_logger("rec.neural.vae_rec")

class VariationalAutoencoderRecConfig(BaseModel):
...
class VariationalAutoencoderRec:
    """Variational Autoencoder (Mult-VAE) utilizing multinomial likelihood for collaborative ranking"""

    def __init__(self, config: Optional[VariationalAutoencoderRecConfig] = None):
        self.config = config or VariationalAutoencoderRecConfig()
