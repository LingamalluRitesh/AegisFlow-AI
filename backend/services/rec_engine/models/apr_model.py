"""
PulseRec Neural Architecture: AdversarialPersonalizedRanking
Adversarial training adding adversarial noise to user/item embeddings for robust ranking
"""
...
logger = get_logger("rec.neural.apr_model")

class AdversarialPersonalizedRankingConfig(BaseModel):
...
class AdversarialPersonalizedRanking:
    """Adversarial training adding adversarial noise to user/item embeddings for robust ranking"""

    def __init__(self, config: Optional[AdversarialPersonalizedRankingConfig] = None):
        self.config = config or AdversarialPersonalizedRankingConfig()
