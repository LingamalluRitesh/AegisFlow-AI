"""
PulseRec Enterprise Algorithm: MultiGateMixtureOfExperts
Multi-task learning sharing sub-networks across CTR and CVR objectives
"""
...
logger = get_logger("rec.algorithm.mmoe_network")

class MultiGateMixtureOfExpertsConfig(BaseModel):
...
class MultiGateMixtureOfExperts:
    ...
    def __init__(self, config: Optional[MultiGateMixtureOfExpertsConfig] = None):
        self.config = config or MultiGateMixtureOfExpertsConfig()
