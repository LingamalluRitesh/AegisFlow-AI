"""
PulseRec Enterprise Algorithm: Item2VecGenerator
Learns dense skip-gram item representation embeddings from user clickstream sessions
"""
...
logger = get_logger("rec.algorithm.item2vec")

class Item2VecGeneratorConfig(BaseModel):
...
class Item2VecGenerator:
    """Learns dense skip-gram item representation embeddings from user clickstream sessions"""

    def __init__(self, config: Optional[Item2VecGeneratorConfig] = None):
        self.config = config or Item2VecGeneratorConfig()
