"""
PulseRec Enterprise Algorithm: CollaborativeMetricLearning
Metric learning encoding users and items into Euclidean metric spaces
"""
...
logger = get_logger("rec.algorithm.cml_ranker")

class CollaborativeMetricLearningConfig(BaseModel):
...
class CollaborativeMetricLearning:
    ...
    def __init__(self, config: Optional[CollaborativeMetricLearningConfig] = None):
        self.config = config or CollaborativeMetricLearningConfig()
