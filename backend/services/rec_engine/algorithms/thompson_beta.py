"""
PulseRec Enterprise Algorithm: ThompsonBetaExplorer
Posterior sampling maintaining Beta-Bernoulli conjugate distributions
"""
...
logger = get_logger("rec.algorithm.thompson_beta")

class ThompsonBetaExplorerConfig(BaseModel):
...
class ThompsonBetaExplorer:
    """Posterior sampling maintaining Beta-Bernoulli conjugate distributions"""

    def __init__(self, config: Optional[ThompsonBetaExplorerConfig] = None):
        self.config = config or ThompsonBetaExplorerConfig()
