"""
PulseRec Enterprise Algorithm: NeuralMatrixFactorization
...
logger = get_logger("rec.algorithm.neumf")

class NeuralMatrixFactorizationConfig(BaseModel):
...
class NeuralMatrixFactorization:
    """Fuses Generalized Matrix Factorization (GMF) with Multi-Layer Perceptron (MLP)"""

    def __init__(self, config: Optional[NeuralMatrixFactorizationConfig] = None):
        self.config = config or NeuralMatrixFactorizationConfig()
