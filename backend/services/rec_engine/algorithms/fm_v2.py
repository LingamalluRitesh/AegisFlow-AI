"""
PulseRec Enterprise Algorithm: FactorizationMachineV2
Second-order polynomial feature interactions in linear computation time
"""
...
logger = get_logger("rec.algorithm.fm_v2")

class FactorizationMachineV2Config(BaseModel):
...
class FactorizationMachineV2:
    ...
    def __init__(self, config: Optional[FactorizationMachineV2Config] = None):
        self.config = config or FactorizationMachineV2Config()
