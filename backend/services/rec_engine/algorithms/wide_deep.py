"""
PulseRec Enterprise Algorithm: WideAndDeepModel
Joint memorization (linear) and generalization (deep) recommendation architecture
"""
...
logger = get_logger("rec.algorithm.wide_deep")

class WideAndDeepModelConfig(BaseModel):
...
class WideAndDeepModel:
    ...
    def __init__(self, config: Optional[WideAndDeepModelConfig] = None):
        self.config = config or WideAndDeepModelConfig()
