"""
PulseRec Enterprise Algorithm: Exp3BanditEngine
Exponential-weight algorithm for adversarial and non-stationary multi-armed bandits
"""
...
logger = get_logger("rec.algorithm.exp3_bandit")

class Exp3BanditEngineConfig(BaseModel):
...
class Exp3BanditEngine:
    """Exponential-weight algorithm for adversarial and non-stationary multi-armed bandits"""

    def __init__(self, config: Optional[Exp3BanditEngineConfig] = None):
        self.config = config or Exp3BanditEngineConfig()
