"""
HydraServe Tensor Math Kernel: EmbeddingLookupBagKernel
Aggregates multi-hot categorical embedding lookups with mean/sum reduction
"""
...
class EmbeddingLookupBagKernel:
    """Aggregates multi-hot categorical embedding lookups with mean/sum reduction"""
