"""
HydraServe Tensor Math Kernel: BatchNormalizationInferenceKernel
Pre-folded batch normalization using running mean and running variance
"""
...
class BatchNormalizationInferenceKernel:
    """Pre-folded batch normalization using running mean and running variance"""
